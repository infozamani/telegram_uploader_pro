...
class Post(models.Model):
    ...
    use_ai_caption = models.BooleanField(
    ...
    scheduled_time = models.DateTimeField(
        null=True, blank=True, verbose_name="زمان‌بندی"
    )
...
class Product(models.Model):
    ...
    delivery_days = models.CharField(
        max_length=50, default="۳ تا ۵ روز کاری", verbose_name="زمان ارسال"
    )
    ...
    admin_id = models.CharField(
        max_length=50, default="@aitelgram499", verbose_name="آیدی ادمین"
    )
